...
function setup() {
  ...
  //trex.setAnimation("trex", trexAnimation);
  ...
  ground = createSprite(200, 380, 16000000000000000, 20);
  //ground.setAnimation("ground2");
  ground.x = ground.width / 2;

  //invisible Ground to support Trex
  invisibleGround = createSprite(200, 385, 16000000000000000000000000000000, 5);
